...
namespace Bamtang
{
    ...
    public:
        ...
        GameObject(std::string const& path, glm::vec3 position, glm::vec3 scale = glm::vec3(1.0f), glm::vec3 rotation = glm::vec3(0.0f), bool gamma = false, int countInstance = 1, glm::mat4* matrix = NULL)
        {
            ...
            this->m_render = new RenderComponent(path, gamma, countInstance, matrix);
        ...
        void UpdateTime(float &currentFrame)
        {
            ...
            m_render->UpdateTime(currentFrame);
        }
        ...
        {
            m_render->RenderInstance(camera, shader);
        }
